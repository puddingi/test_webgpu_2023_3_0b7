...
var ASM_CONSTS = {
  1328704: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 1328759: ($0) => { performance.now = function() { return $0; }; },  
 1328807: ($0) => { performance.now = function() { return $0; }; },  
 1328855: () => { performance.now = Module['emscripten_get_now_backup']; }
};
